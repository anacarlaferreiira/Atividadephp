...
<body>
    ...
    # Posso utilizar hasttag para comentário 
    /**
    ...
    //Variáveis  em PHP
    //Sempe iniciam com $ seguido d o nome da variável
    //Não é nescessário idetificar basta atribui um valor a ela.
    $nome = "Ana Carla";
    $idade = "17";
    $altura = "1,61";
